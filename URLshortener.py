...
class UrlShortener:
    ...
    def shorten(self, longURL):
        # print(iter)
        if longURL not in url_dict.keys():
            global iter

            url_dict["longURL"] = "short.ly/" + chr(97 + iter) + "." + "/"
            iter += 1

        shortURL = url_dict["longURL"]
        return shortURL
...
shortUrl1 = urlShortener.shorten("https://www.codewars.com/kata/5ef9ca8b76be6d001d5e1c3e")
print(shortUrl1)
# longUrl1 = urlShortener.redirect(shortUrl1)
# print(longUrl1, "https://www.codewars.com/kata/5ef9ca8b76be6d001d5e1c3e")
